...
public class GroupSupport extends RealmObject {
    ...
    public GroupSupport(int cve_vehicle_group, String userGroup, String vehicle_group, String desc_vehicle_group, boolean selected, int positionItem, RealmList<VehicleTracking> vehicles) {
