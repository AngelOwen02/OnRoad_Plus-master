...
public class UtilsLoginV2 {
    ...
    public static void saveUserDataSharedPreferences(String urlImage, String user, String token, String email, String password, String employeeName, String origin, Context context) {
        ...
        editor.putString(GeneralConstantsV2.ORIGIN, origin);
