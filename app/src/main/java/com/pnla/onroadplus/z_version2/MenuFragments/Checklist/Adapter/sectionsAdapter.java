...
public class sectionsAdapter extends RecyclerView.Adapter<sectionsAdapter.ViewHolder>{// PagerAdapter {
    ...
    public sectionsAdapter(int posrv , List<dataQuestions> data, int size, Questions mview, Context context) {//(FragmentManager childFragmentManager, List<Banners> banners, Context context) {
        this.posrv=posrv;
