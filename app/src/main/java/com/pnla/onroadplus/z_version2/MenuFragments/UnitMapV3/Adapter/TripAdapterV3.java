...
public class TripAdapterV3 extends RecyclerView.Adapter<TripAdapterV3.ViewHolder> {


    private String vehicleName;
    private List<TripV2> tripList;
    private Context context;
    private TripAdapterV3.OnClickTripListener listener;


    public TripAdapterV3(String vehicleName, List<TripV2> tripList, Context context) {
    ...
    @NonNull
    @Override
    public TripAdapterV3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_trip, parent, false);
        return new TripAdapterV3.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TripAdapterV3.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
    ...
    public void setOnClickTripListener(TripAdapterV3.OnClickTripListener listener) {
