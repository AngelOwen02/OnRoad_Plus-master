package com.pnla.onroadplus.z_version2.MenuFragments.UnitAssignSupport;
...
import com.pnla.onroadplus.z_version2.MenuFragments.UnitAssignSupport.adapter.SimpleTextRecyclerViewAdapter;
...
public class UnitAssignSupportFragment extends AppCompatActivity implements View.OnClickListener /**ZonesViewR */{

    public static List<String> geoZonas = new ArrayList<>();
    private RecyclerView rvUnitsAssign;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_unit_assign_support);
        initView();
    }
    ...
    private void initView() {
        ...
        rvUnitsAssign=findViewById(R.id.recycler_view_units_assign);
    ...
    private void setRV (){
        rvUnitsAssign.setLayoutManager(new LinearLayoutManager(this));
        ...
        rvUnitsAssign.setAdapter(new SimpleTextRecyclerViewAdapter(this, items));

        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(rvUnitsAssign.getContext(),
                DividerItemDecoration.VERTICAL);
        rvUnitsAssign.addItemDecoration(dividerItemDecoration);
...
/*        if(rv.getAdapter().getItemCount()!=0)
    ...
    private void goBackintomenu()
    {
        ...
        Intent intent = new Intent(UnitAssignSupportFragment.this,  menuViewImpl.class);//MainMenuContainerActivity.class);
    ...
    public void showProgressDialog() {
        progressDialog.setMessage("Cargando Apoyos");
